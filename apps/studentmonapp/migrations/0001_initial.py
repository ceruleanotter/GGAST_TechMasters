...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MonitorReport'
        db.create_table('studentmonapp_monitorreport', (
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default='FE', max_length=2)),
            ('signed_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Profile'])),
            ('cover_reason', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('studentmonapp', ['MonitorReport'])

        # Adding model 'MonitorIssue'
        db.create_table('studentmonapp_monitorissue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('monitor_report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['studentmonapp.MonitorReport'])),
            ('severity', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2, max_length=1)),
            ('time_discovered', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_solved', self.gf('django.db.models.fields.DateTimeField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Profile'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('attempted_troubleshooting', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('solved', self.gf('django.db.models.fields.SmallIntegerField')(default=0, max_length=1)),
        ))
        db.send_create_signal('studentmonapp', ['MonitorIssue'])


    def backwards(self, orm):
        # Deleting model 'MonitorReport'
        db.delete_table('studentmonapp_monitorreport')

        # Deleting model 'MonitorIssue'
        db.delete_table('studentmonapp_monitorissue')
    ...
    models = {
        ...
        'studentmonapp.monitorissue': {
            ...
            'attempted_troubleshooting': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
        ...
        'studentmonapp.monitorreport': {
            ...
            'cover_reason': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
